...
class DataArguments:
    ...
    train_data_file: Optional[str] = field(
        default=None, metadata={"help": "Path to the train jsonl file."}
    )
    test_data_file: Optional[str] =field(
        default=None, metadata={"help": "Path to the test (eval) jsonl file."}
    )
...
class DPOConfig(transformers.TrainingArguments):
    ...
    loss_type: Optional[str] = field(
        default="sigmoid",
        metadata={"help": ("The type of loss to use for training. Options are `dpo` or `trl`.")},
    )
